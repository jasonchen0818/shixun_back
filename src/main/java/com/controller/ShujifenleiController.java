...
public class ShujifenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShujifenleiEntity shujifenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShujifenleiEntity shujifenlei, HttpServletRequest request){
        EntityWrapper<ShujifenleiEntity> ew = new EntityWrapper<ShujifenleiEntity>();
		PageUtils page = shujifenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shujifenlei), params), params));
        return R.ok().put("data", page);
    }
