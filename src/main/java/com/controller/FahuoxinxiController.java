...
public class FahuoxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FahuoxinxiEntity fahuoxinxi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FahuoxinxiEntity fahuoxinxi, HttpServletRequest request){
        EntityWrapper<FahuoxinxiEntity> ew = new EntityWrapper<FahuoxinxiEntity>();
		PageUtils page = fahuoxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fahuoxinxi), params), params));
        return R.ok().put("data", page);
    }
