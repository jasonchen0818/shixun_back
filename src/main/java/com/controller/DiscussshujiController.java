...
public class DiscussshujiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussshujiEntity discussshuji, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussshujiEntity discussshuji, HttpServletRequest request){
        EntityWrapper<DiscussshujiEntity> ew = new EntityWrapper<DiscussshujiEntity>();
		PageUtils page = discussshujiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussshuji), params), params));
        return R.ok().put("data", page);
    }
